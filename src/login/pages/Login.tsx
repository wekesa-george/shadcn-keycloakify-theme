...
export default function Login(props: PageProps<Extract<KcContext, { pageId: "login.ftl" }>, I18n>) {
    ...
    return (
        <Template
            ...
            socialProvidersNode={social && <SocialProviders social={social} kcClsx={kcClsx} clsx={clsx} msg={msg} realm={realm} />}
        >
            <div id="kc-form">
                <div id="kc-form-wrapper">
                    {realm.password && (
                        ...
                        >
                            ...
                            <div className="space-y-2 md:space-y-0 md:flex md:justify-between text-[14px] ">
                                <div>
